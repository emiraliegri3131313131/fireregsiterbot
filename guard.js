...
const dokunma = ['453925654535208973', '471031283091374091', '602797560049958922'];
const sunucu = "797549063452622909"; 

const strigaban = '797561691293483028'// RAPOR VERMESİ İÇİN LOG ID
const strigakick = '797561827768139826'// RAPOR VERMESİ İÇİN LOG ID
const strigarol = '797561933837369414'// RAPOR VERMESİ İÇİN LOG ID
const strigakanal = '797562108240723988'// RAPOR VERMESİ İÇİN LOG ID
const strigasunucu = '797562386117951508'// RAPOR VERMESİ İÇİN LOG ID
const strigawebhook = '797562781700063253'// RAPOR VERMESİ İÇİN LOG ID
const strigaurl = '797564160716177418'// RAPOR VERMESİ İÇİN LOG ID
const strigabotkoruma = '797564298292887632' // RAPOR VERMESİ İÇİN LOG ID
const botroles = ["797560343294378005"] // BOT ROLLERI
...
.setColor('#c43636')
.setFooter(`Calm Down This Is DEX †`)
...
client.login("Nzg5NTU3OTk0NzE0NDMxNDg4.X9zzLw.1mXcwD-U5snKaA2E5cfzl7XlnlU");
